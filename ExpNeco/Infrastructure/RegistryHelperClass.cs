...
namespace ExpNeco.Infrastructure
{
    public class RegistryHelperClass
    {
        ...
        {
            get { return regMapper.Getvalue("InconsistentFile"); }
            set { regMapper.Setvalue("InconsistentFile", value); }
        }

        public int InconsistentFilesCount
        {
            get { return Convert.ToInt32(regMapper.Getvalue("InconsistentFilesCount")); }
            set { regMapper.Setvalue("InconsistentFilesCount", value.ToString()); }
        }
